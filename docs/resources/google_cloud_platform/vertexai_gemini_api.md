...
the [Gemini Developer API](https://ai.google.dev/gemini-api/docs) and the [Vertex AI Gemini API](https://cloud.google.com/vertex-ai/generative-ai/docs/overview).
...
the `google-genai` library. See the [libraries](https://ai.google.dev/gemini-api/docs/libraries) page
...
library. See [libraries](https://ai.google.dev/gemini-api/docs/libraries) page for instructions on how
...
Refer to use case specific guides on [Gemini Developer API Documentation](https://ai.google.dev/gemini-api/docs)
