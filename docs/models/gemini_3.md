...
| Thinking Level | Gemini 3.1 Pro | Gemini 3 Pro (*Deprecated*) | Gemini 3 Flash | Description |
|---|---|---|---|---|
...
3. **Is there a free tier for Gemini 3?** Gemini 3 Flash
   ...
   Gemini 3.1 Pro and 3 Flash for free in Google AI Studio, but there
